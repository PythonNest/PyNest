from nest.core.database.config import BaseOdmConfig, ConfigFactoryBase


class MongoDBConfig(BaseOdmConfig):
    """
    ...
    def __init__(self, host: str, db_name: str, user: str, password: str, port: int = 27017, srv: bool = False):
        """
